...
sed -i 's/ssid=OpenWrt/ssid=why/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
...
sed -i '/set wireless.default_radio${devidx}.encryption=psk2/a\set wireless.default_radio${devidx}.key=nicaibuzhao' package/kernel/mac80211/files/lib/wifi/mac80211.sh
